 ...
 *
 * <p>
 * Danh sach tac gia va danh muc duoc truyen bang id de tranh tao du lieu long
 * nhau.
 * </p>
 */
public record BookRequest(
	...
	@NotNull(message = "Ngày xuất bản không được để trống") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate publicationDate,
	String language,
	Integer pageCount,
	Long publisherId,
	List<Long> authorIds,
